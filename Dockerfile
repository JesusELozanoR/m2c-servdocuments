...
RUN dotnet nuget add source --name 'local Tecas v3' http://192.168.101.28:8050/Desarrollo/_packaging/DESARROLLO_TEST/nuget/v3/index.json --configfile NuGet.Config --username 'TKS/pharevalo' --password 'Wixi671_Wg%J' --store-password-in-clear-text --valid-authentication-types ntlm
