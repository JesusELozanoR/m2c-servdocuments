...
RUN dotnet nuget add source --username 'pharevalo' --password 'Wixi671_Wg%J' --store-password-in-clear-text --name local_x0020_Tecas_x0020_v3 http://192.168.101.28:8050/Desarrollo/_packaging/DESARROLLO_TEST/nuget/v3/index.json
RUN dotnet nuget add source --name local_x0020_Tecas http://10.10.200.2/TcsNugetServer/nuget
