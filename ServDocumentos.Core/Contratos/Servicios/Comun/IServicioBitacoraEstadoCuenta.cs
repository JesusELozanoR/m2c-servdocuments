...
{
    /// <summary>
    /// Define los metodos para el revicio de bitacora estado cuenta
    /// </summary>
    public interface IServicioBitacoraEstadoCuenta
    {
        /// <summary>
        ...
        int ActualizaEstadoCuenta(ActualizaEstadoCuentaDto estadoCuenta);
        /// <summary>
