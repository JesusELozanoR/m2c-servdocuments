...
{
    /// <summary>
    /// Abstraccion del repositorios de grupos
    /// </summary>
    public abstract class RepositorioApiGruposBase : IRepositorioGruposApi
    {
        /// <summary>
        ...
        /// <summary>
        /// Url para obtener un grupo en base a su id
        /// </summary>
        private const string UrlGetById = "groups/{0}";
        /// <summary>
        ...
        public RepositorioApiGruposBase(
            GestorLog gestorLog,
        ...
        public async Task<GrupoDto> GetById(string id) => await GetById(id, DetailsLevel.BASIC);
        /// <summary>
        /// Obtener grupo en base a su id o encoded key
        /// </summary>
        /// <param name="id">Id o encoded key del grupo</param>
        ...
        /// <returns>Informacion del grupo</returns>
        public async Task<GrupoDto> GetById(string id, DetailsLevel detailsLevel)
        {
            try
            {
                _gestorLog.Entrar();
