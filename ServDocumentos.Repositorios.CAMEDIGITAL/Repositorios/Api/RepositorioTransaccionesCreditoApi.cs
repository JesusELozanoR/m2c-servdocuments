...
{
    /// <summary>
    /// Respositorio de transacciones de credito CAME
    /// </summary>
    public class RepositorioTransaccionesCreditoApi : RepositorioApiTransaccionesCreditoBase
    {
        /// <summary>
        ...
        public RepositorioTransaccionesCreditoApi(
            GestorLog gestorLog,
